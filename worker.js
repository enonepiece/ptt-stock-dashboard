...
async function handleTenDaysAnalytics(request) {
  ...
  const mockTop30 = [
    { rank: 1, code: '2330', name: '台積電', totalMentions: 626, avgMentions: 62.6, price: 2365, change: 45, changePct: 1.94, dailyMentions: { '2026/07/24': 50, '2026/07/27': 51, '2026/07/28': 58, '2026/07/29': 38, '2026/07/30': 53, '2026/07/31': 44, '2026/08/03': 92, '2026/08/04': 126, '2026/08/05': 31, '2026/08/06': 83 }, samplePushes: [{ date: '2026/08/06', content: '台積電(2330)AI需求強勁，先進製程產能吃緊' }, { date: '2026/08/04', content: '2330尾盤大單敲進，護國神山穩大盤' }, { date: '2026/08/03', content: 'GG今年EPS上看50元，外資續抱' }] },
    { rank: 2, code: '2327', name: '國巨*', totalMentions: 440, avgMentions: 44.0, price: 550, change: 12, changePct: 2.23, dailyMentions: { '2026/07/24': 14, '2026/07/27': 55, '2026/07/28': 41, '2026/07/29': 61, '2026/07/30': 114, '2026/07/31': 16, '2026/08/03': 49, '2026/08/04': 53, '2026/08/05': 14, '2026/08/06': 23 }, samplePushes: [{ date: '2026/07/30', content: '國巨2327被動元件報價看漲，買盤強勁' }] },
    { rank: 3, code: '00632R', name: '元大台灣50反1', totalMentions: 428, avgMentions: 42.8, price: 10.36, change: -0.05, changePct: -0.48, dailyMentions: { '2026/07/24': 2, '2026/07/27': 2, '2026/07/28': 3, '2026/07/29': 3, '2026/07/30': 2, '2026/07/31': 16, '2026/08/03': 14, '2026/08/04': 205, '2026/08/05': 112, '2026/08/06': 69 }, samplePushes: [{ date: '2026/08/04', content: '大盤波動避險買盤湧入反1' }] },
    { rank: 4, code: '0050', name: '元大台灣50', totalMentions: 412, avgMentions: 41.2, price: 102.55, change: 1.25, changePct: 1.23, dailyMentions: { '2026/07/24': 11, '2026/07/27': 16, '2026/07/28': 8, '2026/07/29': 62, '2026/07/30': 54, '2026/07/31': 65, '2026/08/03': 29, '2026/08/04': 89, '2026/08/05': 48, '2026/08/06': 30 }, samplePushes: [{ date: '2026/08/04', content: '0050定期定額扣款人數再創新高' }] },
    { rank: 5, code: '00631L', name: '元大台灣50正2', totalMentions: 386, avgMentions: 38.6, price: 33.64, change: 0.85, changePct: 2.59, dailyMentions: { '2026/07/24': 38, '2026/07/27': 24, '2026/07/28': 27, '2026/07/29': 55, '2026/07/30': 34, '2026/07/31': 52, '2026/08/03': 31, '2026/08/04': 61, '2026/08/05': 47, '2026/08/06': 17 }, samplePushes: [{ date: '2026/08/04', content: '正2少年神拉回加碼' }] },
